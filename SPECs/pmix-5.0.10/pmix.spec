...
%if %{install_in_opt}
%define _prefix %{opt_prefix_base}/%{version}
%define _sysconfdir %{opt_prefix_base}/%{version}/etc
%define _libdir %{opt_prefix_base}/%{version}/lib
%define _includedir %{opt_prefix_base}/%{version}/include
%define _mandir %{opt_prefix_base}/%{version}/man
...
# %{name} or %{_name}).
%define _pkgdatadir %{opt_prefix_base}/%{version}/share/pmix
...
# suggests $prefix/doc.
%define _defaultdocdir %{opt_prefix_base}/%{version}/doc
# Also put the modulefile in /opt.
%define modulefile_path %{opt_prefix_base}/%{version}/share/pmixmodulefiles
%endif
